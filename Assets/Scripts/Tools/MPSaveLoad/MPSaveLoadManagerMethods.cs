...
{
	public interface IMPSaveLoadManagerMethod
	{
		void Save(object objectToSave, FileStream saveFile);
		object Load(System.Type objectType, FileStream saveFile);
	}

	public enum MPSaveLoadManagerMethods { Json, JsonEncrypted, Binary, BinaryEncrypted };

	public abstract class MPSaveLoadManagerEncrypter
	{
