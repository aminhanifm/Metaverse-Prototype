...
{
	[Serializable]
	public struct MPSoundManagerPlayOptions
	{
		/// the track on which to play the sound
		public MPSoundManager.MPSoundManagerTracks MPSoundManagerTrack;
		...
		public static MPSoundManagerPlayOptions Default
		{
			get
			{
				MPSoundManagerPlayOptions defaultOptions = new MPSoundManagerPlayOptions();
				defaultOptions.MPSoundManagerTrack = MPSoundManager.MPSoundManagerTracks.Sfx;
