...
{
	[Serializable]
	public class MPSoundManagerSettings
	{
		...
		[Header("Save & Load")]
		/// whether or not the MPSoundManager should automatically load settings when starting
		[Tooltip("whether or not the MPSoundManager should automatically load settings when starting")]
		public bool AutoLoad = true;
		/// whether or not each change in the settings should be automaticall saved. If not, you'll have to call a save MPSoundManager event for settings to be saved.
		[Tooltip("whether or not each change in the settings should be automaticall saved. If not, you'll have to call a save MPSoundManager event for settings to be saved.")]
